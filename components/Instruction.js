...
import logo from "../assests/NIMBUS FONT 2.svg";

const Instruction = () => {
  return (
    <div className=" h-[100vh] lg:flex-row  sm:flex ">
      <div className=" bg-[#34377A] h-full w-[390px] relative">
      ...
      <div className="flex flex-col mx-auto">
        <div className="w-[50vw] flex flex-col items-center">
              ...
              <div className=" w-fit mx-[2vw] mt-4 bg-transparent">
                ...
                <div className=" bg-[#D9D9D9]">
                  <li className=" bg-transparent">
                    This assessment test consists of 4 sections having 5
                    Questions each
                  </li>
                  <li className=" bg-transparent">
                    We suggest you allow 90 minutes to complete the test.
                  </li>
                  <li className=" bg-transparent">
          ...
          <div className=" mt-[10vh] w-full cursor-pointer h-[5vh]">
            <button className="w-full bg-[#34377A] h-full rounded-xl leading-6 text-[#fff] font-bold size-5 ">
              Start Test
            </button>
          </div>
        </div>
